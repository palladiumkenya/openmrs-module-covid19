 ...
 */
@Handler(supports = FacilityReferredFromDataDefinition.class, order = 50)
public class FacilityReferredFromDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, hospital_referred_from from kenyaemr_etl.etl_cca_covid_treatment_enrollment ";
