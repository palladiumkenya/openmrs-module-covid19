...
/**
 * Evaluator for COVID-19 AG RDT tests cohort definition
 */
@Handler(supports = { CovidRDTTestsCohortDefinition.class })
public class CovidRDTTestsCohortDefinitionEvaluator implements EncounterQueryEvaluator {
	...
	public EncounterQueryResult evaluate(EncounterQuery definition, EvaluationContext context) throws EvaluationException {
		...
		String qry = "select encounter_id from kenyaemr_etl.etl_cca_covid_rdt_test where date(visit_date) between date(:startDate) and date(:endDate);";
