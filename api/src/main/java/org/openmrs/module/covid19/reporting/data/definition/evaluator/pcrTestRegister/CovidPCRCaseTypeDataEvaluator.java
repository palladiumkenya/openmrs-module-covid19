...
/**
 * Evaluator for PCR case type
 */
@Handler(supports = CovidPCRCaseTypeDataDefinition.class, order = 50)
public class CovidPCRCaseTypeDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, case_type from kenyaemr_etl.etl_cca_covid_clinical_review ";
