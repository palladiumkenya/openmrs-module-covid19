 ...
 */
@Handler(supports = CovidCaseClassificationDataDefinition.class, order = 50)
public class CovidCaseClassificationDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, case_classification from kenyaemr_etl.etl_cca_covid_treatment_enrollment ";
