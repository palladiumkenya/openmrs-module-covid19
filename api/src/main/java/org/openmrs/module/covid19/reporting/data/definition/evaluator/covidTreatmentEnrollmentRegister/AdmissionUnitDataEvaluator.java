 ...
 */
@Handler(supports = AdmissionUnitDataDefinition.class, order = 50)
public class AdmissionUnitDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, admission_unit from kenyaemr_etl.etl_cca_covid_treatment_enrollment ";
