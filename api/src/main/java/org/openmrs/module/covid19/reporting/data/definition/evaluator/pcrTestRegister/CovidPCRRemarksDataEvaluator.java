 ...
 */
@Handler(supports = CovidPCRRemarksDataDefinition.class, order = 50)
public class CovidPCRRemarksDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, notes from kenyaemr_etl.etl_cca_covid_clinical_review ";
