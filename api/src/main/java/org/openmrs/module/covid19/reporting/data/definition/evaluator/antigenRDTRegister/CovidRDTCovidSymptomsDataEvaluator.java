 ...
 */
@Handler(supports = CovidRDTCovidSymptomsDataDefinition.class, order = 50)
public class CovidRDTCovidSymptomsDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select t.encounter_id, concat_ws(',', "
		        ...
		        + " ) symptoms from kenyaemr_etl.etl_cca_covid_rdt_test t inner join kenyaemr_etl.etl_cca_covid_screening s on s.patient_id = t.patient_id and date(s.visit_date) = date(t.visit_date)";
