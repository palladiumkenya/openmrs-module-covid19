 ...
 */
@Handler(supports = CovidPatientTypeDataDefinition.class, order = 50)
public class CovidPatientTypeDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, patient_type from kenyaemr_etl.etl_cca_covid_treatment_enrollment ";
