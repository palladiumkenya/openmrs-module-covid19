 ...
 */
@Handler(supports = { PatientsEnrolledInCCACovidTreatmentCohortDefinition.class })
public class PatientsEnrolledInCCACovidTreatmentCohortDefinitionEvaluator implements EncounterQueryEvaluator {
	...
	public EncounterQueryResult evaluate(EncounterQuery definition, EvaluationContext context) throws EvaluationException {
		...
		String qry = "Select e.encounter_id from kenyaemr_etl.etl_cca_covid_treatment_enrollment e\n"
