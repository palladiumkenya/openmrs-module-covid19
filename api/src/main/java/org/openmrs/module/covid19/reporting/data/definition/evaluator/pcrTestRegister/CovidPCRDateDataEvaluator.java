 ...
 */
@Handler(supports = CovidPCRDateDataDefinition.class, order = 50)
public class CovidPCRDateDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, pcr_sample_collection_date from kenyaemr_etl.etl_cca_covid_clinical_review ";
