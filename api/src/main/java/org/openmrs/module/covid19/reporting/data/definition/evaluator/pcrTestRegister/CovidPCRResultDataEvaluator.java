...
/**
 * Evaluator for PCR test result
 */
@Handler(supports = CovidPCRResultDataDefinition.class, order = 50)
public class CovidPCRResultDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, pcr_result from kenyaemr_etl.etl_cca_covid_clinical_review ";
