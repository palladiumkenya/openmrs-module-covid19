 ...
 */
@Handler(supports = CovidPCREmailDataDefinition.class, order = 50)
public class CovidPCREmailDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, email from kenyaemr_etl.etl_cca_covid_clinical_review ";
