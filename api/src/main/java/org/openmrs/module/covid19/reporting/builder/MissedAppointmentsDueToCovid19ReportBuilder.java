...
@Component
@Builds({ "kenyaemr.common.report.missedAppointmentsDueToCovid19" })
public class MissedAppointmentsDueToCovid19ReportBuilder extends AbstractHybridReportBuilder {
	...
	protected void addColumns(HybridReportDescriptor report, PatientDataSetDefinition dsd) {
		...
		dsd.addColumn("Last HIV Appointment date", new CalculationDataDefinition("Appointment date",
		        new LastReturnVisitDateCalculation()), "", new DataConverter[] { new CalculationResultConverter() });
	...
	protected Mapped<CohortDefinition> buildCohort(HybridReportDescriptor descriptor, PatientDataSetDefinition dsd) {
		CohortDefinition cd = new MissedAppointmentDueToCovid19CohortDefinition();
		cd.setName("Missed Appointments Due to Covid19");
