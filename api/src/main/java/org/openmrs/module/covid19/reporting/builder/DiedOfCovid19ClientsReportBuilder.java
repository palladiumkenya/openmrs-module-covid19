...
@Component
@Builds({ "kenyaemr.common.report.clients.diedofCovid19" })
public class DiedOfCovid19ClientsReportBuilder extends AbstractHybridReportBuilder {
	...
	protected Mapped<CohortDefinition> buildCohort(HybridReportDescriptor descriptor, PatientDataSetDefinition dsd) {
		CohortDefinition cd = new DiedOfCovid19PatientsCohortDefinition();
		cd.setName("Patients who have died due to Covid19");
