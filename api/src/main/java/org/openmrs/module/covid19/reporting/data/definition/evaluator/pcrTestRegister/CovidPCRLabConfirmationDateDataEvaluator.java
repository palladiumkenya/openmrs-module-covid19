 ...
 */
@Handler(supports = CovidPCRLabConfirmationDateDataDefinition.class, order = 50)
public class CovidPCRLabConfirmationDateDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, pcr_result_date from kenyaemr_etl.etl_cca_covid_clinical_review ";
