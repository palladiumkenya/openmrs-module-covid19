 ...
 */
@Handler(supports = CovidPCRCaseIDDataDefinition.class, order = 50)
public class CovidPCRCaseIDDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id, case_id from kenyaemr_etl.etl_cca_covid_clinical_review ";
